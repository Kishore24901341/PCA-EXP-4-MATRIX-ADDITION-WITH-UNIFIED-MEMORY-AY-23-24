...
## OUTPUT:
### WITH MEMSET
<img width="1028" height="642" alt="image" src="https://github.com/user-attachments/assets/ea0e5de4-d59d-46e8-90e1-45392da313f5" />

### WITHOUT MEMSET
<img width="1009" height="640" alt="image" src="https://github.com/user-attachments/assets/8e795f06-471b-49b7-a13c-808a8b71970f" />

## RESULT:
Thus, the program has been executed by using unified memory. It is observed that removing the memset function has reduced the execution time from 0.120994 sec to 0.083654 sec.
